...
const envSchema = z
  .object({
    ...
    DISCORD_CITIZEN_ROLE_ID: z.string().min(1).optional(),
    DISCORD_CREATORS_CATEGORY_ID: z.string().min(1).optional(),
    DISCORD_ARCHIVED_TICKETS_CATEGORY_ID: z.string().min(1).optional(),
    DISCORD_STAFF_ROLE_IDS: z.string().min(1).optional(),
...
export const env = {
  ...
  DISCORD_CITIZEN_ROLE_ID: rawEnv.DISCORD_CITIZEN_ROLE_ID,
  DISCORD_CREATORS_CATEGORY_ID: rawEnv.DISCORD_CREATORS_CATEGORY_ID,
  DISCORD_ARCHIVED_TICKETS_CATEGORY_ID: rawEnv.DISCORD_ARCHIVED_TICKETS_CATEGORY_ID,
  DISCORD_STAFF_ROLE_IDS: rawEnv.DISCORD_STAFF_ROLE_IDS,
