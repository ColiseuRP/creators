...
const noticesBase: CreatorNotice[] = [
  ...
  },
  {
    ...
    message: "Todos os creators devem anexar print do analytics com data visível.",
    type: "warning",
    target_type: "general",
...
const discordLogsBase: DiscordMessageLog[] = [
  {
    ...
    target_creator_id: "creator-2",
    channel_id: "987654321000000002",
    message_type: "metric_approved",
    status: "sent",
    error_message: null,
    sent_at: "2026-04-27T17:02:00.000Z",
  },
  {
    id: "log-2",
    target_type: "metric_review",
    ...
    status: "failed",
    error_message: "Missing access to channel 987654321000000001.",
